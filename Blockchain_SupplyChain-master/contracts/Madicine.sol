...
contract Madicine {
    ...
    function pickPackage(
        ...
        require(
            ...
            "Package must be at Supplier." ///shld be manufacturer instead of supplier
        );
        ...
        if(wholesaler!=address(0x0)){
            ...
            emit ShippmentUpdate(address(this),shipper,distributer,1,1); ///last parameter shld have value 2
        }
    }
